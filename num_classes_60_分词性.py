...
class BaseCMN(AttModel):
    ...
    def __init__(self, args, tokenizer):
        ...
        # !!! mapping by disease classes
        self.semantic = SemanticMap(self.d_model, self.num_classes, self.dropout)
        ...
        self.memory_matrix = nn.Parameter(torch.FloatTensor(self.num_classes * 32, args.cmm_dim)) # 多模态记忆 memory matrix 98 * 32 98个patches 
    ...
    def _prepare_feature_forward(self, att_feats, att_masks=None, seq=None): # [batch_size, 98, d_vf], None, [batch_size, max_seq_len]
        ...
        image_memory_matrix = self.memory_matrix.view(self.num_classes, 32, -1) # 20 融合之后的token数
