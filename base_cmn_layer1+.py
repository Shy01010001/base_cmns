...
class SemanticMap(nn.Module):
    def __init__(self, d_model, num_classes, dropout = 0):
        ...
        self.attn = nn.Sequential(nn.Linear(512, 2048), nn.Relu(), nn.Linear(d_model, num_classes), nn.Softmax())
...
class Encoder(nn.Module):
    def __init__(self, layer, N):
        ...
        self.semantic_map = SemanticMap(512, 70)
        self.semantic_map2 = SemanticMao(512, 60)
...
class BaseCMN(AttModel):
    ...
    def __init__(self, args, tokenizer):
        ...
        self.memory_matrix = nn.Parameter(torch.FloatTensor(640, args.cmm_dim)) # 多模态记忆 memory matrix
